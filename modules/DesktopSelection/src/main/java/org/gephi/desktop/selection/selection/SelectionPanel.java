...
public class SelectionPanel extends JPanel {
    ...
    public void refreshSelectedNodes(final SelectionUIModelImpl model) {
    ...
    private Icon getTypeIcon(Column column) {
        if (column.isDynamicAttribute()) {
            return ImageUtilities.loadImageIcon("DesktopSelection/dynamic.svg", false);
        } else if (column.isNumber()) {
            return ImageUtilities.loadImageIcon("DesktopSelection/number.svg", false);
        } else if (column.isArray()) {
            return ImageUtilities.loadImageIcon("DesktopSelection/array.svg", false);
        } else if (column.getTypeClass() == Boolean.class) {
            return ImageUtilities.loadImageIcon("DesktopSelection/boolean.svg", false);
        }
        return ImageUtilities.loadImageIcon("DesktopSelection/string.svg", false);
    }
